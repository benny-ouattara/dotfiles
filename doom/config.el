...
(after! notmuch
  ...
  (setq notmuch-fcc-dirs '(("benny.ouattara@gmail.com"  . "gmail/sent +sent")
                            ...
                            ("support@jaza.cash"        . "jcash-support/sent +sent")
                            ("ops@jaza.cash"            . "jcash-ops/sent +sent")
                            ("compliance@jaza.cash"     . "jcash-compliance/sent +sent")
                            ("info@jaza.cash"           . "jcash-info/sent +sent")
                            ("fraud@jaza.cash"          . "jcash-fraud/sent +sent")
                            ("hr@jaza.cash"             . "jcash-hr/sent +sent")
                            ("sales@jaza.cash"          . "jcash-sales/sent +sent")
                            ("system@jaza.cash"         . "jcash-system/sent +sent")
                            ("ben@jazagroup.com"        . "jgroup-ben/sent +sent")
                            ("system@jazagroup.com"     . "jgroup-system/sent +sent")))
  ...
  (setq notmuch-saved-searches
        '((:name "inbox"             :query "tag:inbox and tag:unread"        :key "i" :count-query "tag:inbox and tag:unread")
          ...
          (:name "jcash"             :query "tag:jcash and tag:unread"        :key "j" :count-query "tag:jcash and tag:unread")
          (:name "jfund"             :query "tag:jfund and tag:unread"        :key "f" :count-query "tag:jfund and tag:unread")
          (:name "jgroup"            :query "tag:jgroup and tag:unread"       :key "r" :count-query "tag:jgroup and tag:unread")
  ...
  (evil-define-key 'normal notmuch-hello-mode-map
    ...
    "j" (cmd! (notmuch-search "tag:jcash and tag:unread"))
    "f" (cmd! (notmuch-search "tag:jfund and tag:unread"))
    "r" (cmd! (notmuch-search "tag:jgroup and tag:unread"))
